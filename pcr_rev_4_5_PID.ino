...
const double INITIALIZATION = 95;
const double DENATURATION = 95;
const double ANNEAL = 55;
const double EXTENSION = 72;
const double FINAL_ELONGATION = 72;
...
void loop() 
{
  ...
  for (int i = 0; i < NUMBER_OF_CYCLES ;i++)
  {
    ...
    settemperature(ANNEAL, 60);
    settemperature(EXTENSION, 60);
  }
  cycle++;
  settemperature(FINAL_ELONGATION, 300);
  while (1)
  {
